...
The risk values shown are percentages that can theoretically can range from 0% to 100%. These were created from raw risk probabilities that range from 0 to 1. 
